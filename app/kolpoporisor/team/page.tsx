    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative py-24 md:py-32 bg-foreground text-background border-b border-border">
        <div className="container mx-auto px-6 md:px-14">
          ...
          >
            The minds behind every line, structure, and space we create.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-end mb-16">
            ...
            <div className="md:col-span-8">
              <ScrollReveal>
                ...
                <p className="mt-3 text-muted-foreground text-sm max-w-lg">A multidisciplinary team united by a commitment to design excellence.</p>
              </ScrollReveal>
            </div>
          </div>
