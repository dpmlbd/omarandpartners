    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative py-24 md:py-32 bg-foreground text-background border-b border-border">
        <div className="container mx-auto px-6 md:px-14">
          ...
          >
            Tell us about your project vision. Our team will respond within 24 hours.
          </motion.p>
        </div>
      </section>
              ...
              <ScrollReveal delay={0.2}>
                ...
                <div className="flex flex-col gap-6 text-sm font-light text-muted-foreground">
                  <div className="flex items-start gap-4">
                    ...
                    <p>We review your project brief and match you with the right lead architect.</p>
                  </div>
                  <div className="flex items-start gap-4">
                    <span className="text-primary font-mono text-xs">02</span>
                    <p>A discovery call is scheduled to discuss scope, timeline, and budget.</p>
                  </div>
                  <div className="flex items-start gap-4">
                    <span className="text-primary font-mono text-xs">03</span>
                    <p>We prepare a tailored proposal with fee structure and project roadmap.</p>
                  </div>
                </div>
              </ScrollReveal>
            </div>
