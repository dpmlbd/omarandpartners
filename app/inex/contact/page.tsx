...
export default function InexContactPage() {
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="relative py-24 md:py-32 bg-foreground text-background border-b border-border">
        <div className="container mx-auto px-6 md:px-14">
          ...
          >
            Reach out directly or visit our logistics hub. For general inquiries, use the main contact page.
          </motion.p>
        </div>
      </section>
              ...
              <ScrollReveal>
                <div className="flex flex-col gap-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="font-medium text-foreground uppercase tracking-widest text-[10px] mb-1">Logistics Hub</p>
                      <p className="text-sm text-muted-foreground">12 Warehouse District, Logistics City, NJ 07001</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:supply@inexmaterials.com" className="text-sm text-muted-foreground hover:text-primary transition-colors">supply@inexmaterials.com</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+15551234570" className="text-sm text-muted-foreground hover:text-primary transition-colors">+1 (555) 123-4570</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Monday – Friday: 8:00 AM – 5:00 PM EST</p>
