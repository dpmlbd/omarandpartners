...
const insights = [
  { tag: "Article", title: "The Future of Diagrid Structures", date: "Oct 12, 2026", image: "/images/architecture.png" },
  { tag: "News", title: "Kolpoporisor Wins International Design Award", date: "Sep 28, 2026", image: "/images/hero_architecture.png" },
  { tag: "Press Release", title: "New York Tower Project Breaks Ground", date: "Sep 15, 2026", image: "/images/architecture.png" },
  { tag: "Article", title: "Sustainable Skyscrapers: Myth or Reality?", date: "Aug 30, 2026", image: "/images/hero_architecture.png" },
];
    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative py-24 md:py-32 bg-foreground text-background border-b border-border">
        <div className="container mx-auto px-6 md:px-14">
          ...
          >
            Perspectives on architecture, urbanism, and the future of the built environment.
          </motion.p>
        </div>
      </section>
