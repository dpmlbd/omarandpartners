...
export default function ContactPage() {
  ...
  return (
    <div className="flex flex-col w-full overflow-hidden">
      ...
      {/* ── 03. SOCIAL MEDIA SECTION ──────────────────────────────── */}
      <section id="social-channels" className="py-24 md:py-36 border-b border-border bg-background">
        <div className="container mx-auto px-6 md:px-14">
          <SectionHeader
            index="03"
            title="Social Media"
      ...
      <section className="py-24 md:py-36 bg-secondary/10">
        <div className="container mx-auto px-6 md:px-14">
          <SectionHeader index="04" title="Frequently Asked Questions" subtitle="Quick answers to common questions about working with us." />
