...
export default function KolpoporisorContactPage() {
  return (
                ...
                <div className="flex flex-col gap-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">88 Skyline Boulevard, New York, NY 10002</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:arch@kolpoporisor.com" className="text-sm text-muted-foreground hover:text-primary transition-colors">arch@kolpoporisor.com</a>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+15551234568" className="text-sm text-muted-foreground hover:text-primary transition-colors">+1 (555) 123-4568</a>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
