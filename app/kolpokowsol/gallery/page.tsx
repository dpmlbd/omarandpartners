    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative py-24 md:py-32 bg-foreground text-background border-b border-border">
        <div className="container mx-auto px-6 md:px-14">
          ...
          >
            A curated visual record of our interior work — from material palettes to completed spaces.
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-end mb-16">
            ...
            <div className="md:col-span-8">
              <ScrollReveal>
                ...
                <p className="mt-3 text-muted-foreground text-sm max-w-lg">Documenting the process and product of our interior design practice.</p>
              </ScrollReveal>
            </div>
          </div>
